          ...
          <div className="cta-reveal flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <ul className="flex flex-col gap-3 p-0 m-0 list-none font-mono text-[13px] tracking-[0.05em] text-[var(--text-muted)]">
                ...
                <li>
                  RESUME: <a href="/DEVANG_PORTFOLIO.pdf" download="DEVANG_PORTFOLIO.pdf" className="text-[var(--text)] font-bold underline underline-offset-4 hover:text-[var(--text-muted)] transition-colors duration-300">Download CV/Resume &darr;</a>
                </li>
              </ul>
            </div>
          </div>
